...
import { Users, MessageSquare, Calendar, Award, ArrowRight, Globe2, UserPlus, BookOpen, Target } from 'lucide-react';
  ...
  const successStories = [
    {
      ...
      story: "From banking to tech in 6 months through TechTransit's mentorship program.",
    },
    {
      name: "David Adebayo",
      role: "Product Manager at Paystack",
      image: "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=400&h=400&fit=crop",
      story: "Transitioned from teaching to product management with TechTransit's guidance.",
    },
    {
      name: "Amina Ibrahim",
      role: "UX Researcher at Paycrest",
      image: "https://img.freepik.com/premium-photo/portrait-smiling-young-woman_1048944-13115821.jpg?uid=R193310056&ga=GA1.1.1570111543.1742967309&semt=ais_items_boosted&w=740",
      story: "Found her passion in UX research through TechTransit's community support.",
    }
  ];
  ...
  const communityFeatures = [
    {
      ...
      description: "Engage in meaningful conversations about tech careers, industry trends, and personal growth."
    },
    {
      icon: Calendar,
      title: "Regular Events",
      description: "Join our weekly workshops, webinars, and networking sessions with industry experts."
    },
    {
      icon: UserPlus,
      title: "Mentorship Program",
      description: "Get paired with experienced professionals who guide your transition into tech."
    },
    {
      icon: BookOpen,
      title: "Resource Library",
      description: "Access our curated collection of learning materials, templates, and guides."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 md:pt-24 pb-6 md:pb-24">
          <div className="text-center"  data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Connect with like-minded individuals, share experiences, and grow together in your tech journey.
            </p>
      ...
      <div className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"  data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600">Everything you need to succeed in your tech journey</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {communityFeatures.map((feature, index) => {
              const IconComponent = feature.icon;
              return (
                <div key={index} className="bg-white p-6 rounded-xl border border-gray-100 hover:shadow-lg transition-shadow"  data-aos="fade-right">
      ...
      <div className="bg-purple-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"  data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600">Join our interactive sessions and learn from the best</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {upcomingEvents.map((event, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm"  data-aos="fade-up">
      ...
      <div className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"  data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600">Meet our community members who successfully transitioned into tech</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {successStories.map((story, index) => (
              <div key={index} className="bg-white rounded-xl shadow-sm p-8"  data-aos="fade-up">
                <img
                  src={story.image}
                  alt={story.name}
      ...
      <div className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"  data-aos="fade-up">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Take the first step towards your tech career. Join our community of ambitious professionals making the transition into tech.
          </p>
          <button className="bg-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-purple-700 transition-colors">
            Join Now
          </button>
